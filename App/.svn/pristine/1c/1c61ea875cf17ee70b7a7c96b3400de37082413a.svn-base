...
/**
 * 
* @ClassName: WXYangHuModel
* @Description: TODO(这里用一句话描述这个类的作用)
* @author dfj
* @date 2016年8月25日 下午2:58:20
*
 */
public class WXYangHuModel {
	/**
	 * 主键
	 */
	private String ids;
	 ...
	 * 维修时间
	 */
	private Timestamp weiXiuTime;
	/**
	 * 养护项目
	 */
	private String yangHuProject;
	/**
	 * 损坏现状描述及原因分析
	 */
	...
	public Timestamp getWeiXiuTime() {
		return weiXiuTime;
	}
	public void setWeiXiuTime(Timestamp weiXiuTime) {
		this.weiXiuTime = weiXiuTime;
	}
	public String getYangHuProject() {
		return yangHuProject;
	}
	public void setYangHuProject(String yangHuProject) {
		this.yangHuProject = yangHuProject;
	}
